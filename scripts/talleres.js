...
async function cargarCategorias() {
    try {
        const res = await fetch("http://localhost:3000/api/consultas/Talleres");
...
async function cargarEventos() {
    try {
        ...
        if (idTipoEvento === "predeterminados") {
            ...
            url = `http://localhost:3000/api/consultas/EventoCategoria/-2`; // 0 indica todas las categorías predeterminadas
        } else {
